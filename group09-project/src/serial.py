...
# Arguments passed
      print("\nName of Python script or directory:", sys.argv[0])

      print("DatasetType Argument passed:", end = " ")
...
#read data set 
      ...
      if sys.argv[1] == 'Gravity':
         ...
         data = read_csv(r'dataset\Gravity.csv')

      if sys.argv[1] == "Gyroscope":
         data = read_csv(r'dataset\Gyroscope.csv')

#extract the axis dimension parameters into arrays
      Z = data['z'].tolist()
      X = data['x'].tolist()
      Y = data['y'].tolist()
